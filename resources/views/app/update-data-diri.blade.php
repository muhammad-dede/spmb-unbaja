...
@section('content')
    ...
    <div class="d-flex flex-center flex-column flex-column-fluid">
        <div class="w-lg-600px p-10 p-lg-15 mx-auto">
            <form action="{{ route('update-data-diri') }}" class="form w-100" id="kt_sign_up_form" method="POST">
                @csrf
                <div class="mb-10 text-center">
                    <h1 class="mb-3" style="color: #142B72;">Update Data Diri</h1>
                ...
                <div class="fv-row mb-7">
                    ...
                    <input class="form-control form-control-lg form-control-solid" type="text" placeholder=""
                        name="nama_lengkap" autocomplete="off" id="nama_lengkap"
                ...
                <div class="fv-row mb-7">
                    ...
                    <input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="nik"
                        autocomplete="off" id="nik" value="{{ old('nik') }}" />
                    @error('nik')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="fv-row mb-7">
                    ...
                    <div class="row mb-0" data-kt-buttons="true">
                        @foreach (all_jenis_kelamin() as $data)
                            <div class="col">
                                <label
                                    ...
                                    <input type="radio" class="btn-check" name="id_jenis_kelamin"
                                        value="{{ $data->id }}"
                                        {{ old('id_jenis_kelamin') == $data->id ? 'checked' : '' }} />
                                    <span class="fw-bolder fs-3">{{ $data->jenis_kelamin }}</span>
                                </label>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="fv-row mb-7">
                    ...
                    <input class="form-control form-control-lg form-control-solid" type="text" placeholder=""
                        name="tempat_lahir" autocomplete="off" id="tempat_lahir" value="{{ old('tempat_lahir') }}" />
                    @error('tempat_lahir')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="fv-row mb-7">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <input type="date" class="form-control form-control-solid ps-12" placeholder="Tanggal Lahir"
                ...
                <div class="fv-row mb-7">
                    ...
                    <select name="id_agama" data-placeholder="" class="form-select form-select-solid">
                        <option value=""></option>
                        @foreach (all_agama() as $data)
                            <option value="{{ $data->id }}" {{ old('id_agama') == $data->id ? 'selected' : '' }}>
                                {{ $data->agama }}</option>
                        @endforeach
                    </select>
                    @error('id_agama')
                ...
                <div class="fv-row mb-7">
                    ...
                    <input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="telp"
                        autocomplete="off" id="telp" value="{{ auth()->user()->phone ?? old('telp') }}" />
                    @error('telp')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
