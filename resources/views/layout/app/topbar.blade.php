    ...
    <div class="d-flex align-items-center ms-3 ms-lg-4">
        <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline btn-outline-secondary w-40px h-40px"
            ...
            <span class="svg-icon svg-icon-1">
                ...
                <span
                    class="bullet bullet-dot bg-danger h-8px w-8px position-absolute translate-middle animation-blink"></span>
            </span>
        </div>
        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
            <div class="d-flex flex-column bgi-no-repeat rounded-top"
                style="background-image:url('http://localhost/spmb-admin/public/template/assets/media/misc/pattern-1.jpg')">
                    ...
                    <div class="d-flex flex-column px-9">
                        ...
                        <div class="text-center px-4">
                            <img class="mw-100 mh-200px" alt="image"
                                src="http://localhost/spmb-admin/public/template/assets/media/illustrations/sketchy-1/1.png" />
                        </div>
                    </div>
                </div>
            </div>
