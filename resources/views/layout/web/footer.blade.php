            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-info">
                        <h3>SPMB UNBAJA</h3>
                        <p class="pb-2">Kampus 1:&nbsp;<em>Warung pojok doni, Jl. Ciwaru Raya No.73, Cipare,
                                Kec.
                                Serang, Kota
                                Serang, Banten 42117.</em></p>
                        <p class="pb-3">Kampus 2:&nbsp;<em>Jl. Syekh Moh. Nawawi Albantani Kp. Boru Kecamatan
                                Curug,
                                Banjarsari, Cipocok Jaya, Kota Serang, Banten 42123.</em></p>
                        <p>
                ...
                <div class="col-lg-4 col-md-6 footer-links">
                    ...
                    <ul>
                        <li>
                            ...
                            <span>Senin - Jumat</span>&nbsp;|&nbsp;<span>Pukul 08.00 - 20.00 WIB</span>
                        </li>
                        <li>
                            <i class="bx bx-time"></i>&nbsp;
